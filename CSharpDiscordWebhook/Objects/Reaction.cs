...
public class Reaction
{
    ...
    /// </summary>
    [JsonInclude] public ReactionDetails CountDetails { get; private set; } = new();
    /// <summary>
    /// Emoji information
    /// </summary>
    [JsonInclude] public Emoji Emoji { get; private set; } = new();
}
...
public class ReactionDetails
{
    ...
    /// </summary>
    [JsonInclude] public int Normal { get; private set; }
    /// <summary>
    /// Count of super reactions
    /// </summary>
    [JsonInclude] public int Burst { get; private set; }
}