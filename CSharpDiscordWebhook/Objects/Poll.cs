...
public class Poll
{
    ...
    /// </summary>
    [JsonInclude]
    public PollMedia Question { get; private set; } = new();

    /// <summary>
    /// Each of the answers available in the poll.
    /// </summary>
    [JsonInclude]
    public IReadOnlyList<PollAnswer> Answers { get; private set; } = new List<PollAnswer>();
...
public class PollAnswer
{
    ...
    /// </summary>
    [JsonInclude]
    public PollMedia PollMedia { get; private set; } = new();
}
